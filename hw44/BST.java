...
public class BST
{
  ...
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /******************************************************
     *boolean remove(int)
     *if int is found in tree (exclusive of root) then int is removed and true is returned
     *else, false is returned
     ****************************************************/
    public boolean remove(int num){
	TreeNode a = _root;
	TreeNode TBR = null; //To Be Removed;
	//to find preceding node:
	if (a.getValue() == num || search(num) == null )
	    return false;
	while (a != null){
            if (a.getLeft() != null && a.getLeft().getValue() == num){
		TBR = a.getLeft();
		break;
	    }
       	    else if (a.getRight() != null && a.getRight().getValue() == num){
		TBR = a.getRight();
		break;
	    }
            else if (num < a.getValue()){
                a = a.getLeft();}
            else if (num > a.getValue()){
                a = a.getRight();}
        }

	//System.out.println(TBR.getValue());
	if (TBR.getLeft() == null && TBR.getRight() == null){
	    if (a.getLeft() != null && a.getLeft().getValue() == num)
		a.setLeft(null);
	    else a.setRight(null);
	    return true;
	}
	else if (TBR.getLeft() != null && TBR.getRight() == null){
	    if (a.getLeft() != null && a.getLeft().getValue() == num)
		a.setLeft(TBR.getLeft());
	    else a.setRight(TBR.getRight());
	    return true;
	}
	else if (TBR.getRight() != null && TBR.getLeft() == null){
	    if (a.getLeft() != null && a.getLeft().getValue() == num)
		a.setLeft(TBR.getRight());
	    else a.setRight(TBR.getLeft());
	    return true;
	}
	else {
	    //find max number in the left side:	    
	    TreeNode maxN = TBR.getLeft();
	    int max = maxN.getValue();
	    while (maxN != null){
		max = maxN.getValue();
		maxN = maxN.getRight();
	    }
	    TreeNode prev = TBR;
	    while (prev.getRight() != null && prev.getRight().getValue() != max)
		prev = prev.getRight();
	    TBR.setValue(max);
	    prev.setRight(null);
	    return true;
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println(arbol.remove(4));
    System.out.println(arbol.remove(2));
    System.out.println(arbol.remove(6));
    System.out.println(arbol.remove(200));
